...
I built this during a weekend hackathon with Anjali Thomas (https://github.com/walkingacorn) because I wanted to see how far a local LLM could get with a real PDF resume.
